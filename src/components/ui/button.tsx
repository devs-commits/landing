  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-accent text-accent-foreground font-heading font-bold tracking-wide hover:brightness-110 shadow-lg hover:shadow-xl transition-all duration-300 uppercase",
        "cta-outline": "border-2 border-accent text-accent font-heading font-bold tracking-wide hover:bg-accent hover:text-accent-foreground transition-all duration-300 uppercase",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-12 rounded-lg px-10 text-base",
        xl: "h-14 rounded-xl px-14 text-lg",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
